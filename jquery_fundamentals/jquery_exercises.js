...
// $(document).ready(function(){
//   $("#target").find("span").text("Googly-googly-googly-begone!");
// });
...
// $(document).ready(function(){
//   $('#target').find('span').clone().insertAfter('#target').css(
//     {
//       'clear': 'left',
//       'float': 'left'
//     });
...
// setTimeout(function(){ alert("It's been two whole seconds!") }, 2000);
